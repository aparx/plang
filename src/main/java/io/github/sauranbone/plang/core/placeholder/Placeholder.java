...
import io.github.sauranbone.plang.core.PlangBitmask;
import io.github.sauranbone.plang.core.map.DataBinder;

import static io.github.sauranbone.plang.core.placeholder.PlaceholderModifier.*;
...
public abstract class Placeholder<T> implements Serializable, PlangBitmask, Transformer<T> {
     ...
     */
    public static <T> Placeholder<T> of(final String name, Class<T> type,
    ...
    /**
     * Allocates a new message placeholder with given callable {@code name}
     * and {@code type} and an identity transformer, meaning that given
     * transformative data is also the resulting and thus displaying
     * token.
     *
     * @param name the target name of the placeholder
     * @param type the target data type that this placeholder triggers
     * @param <T>  the target type of the placeholder
     * @return the newly allocated placeholder instance
     * @throws NullPointerException if any argument is null
     * @see #of(String, Class, Transformer)
     * @see #of(String, Object)
     * @see Transformer#identity()
     */
    public static <T> Placeholder<T> of(final String name, Class<T> type) {
        return of(name, type, Transformer.identity());
    }
