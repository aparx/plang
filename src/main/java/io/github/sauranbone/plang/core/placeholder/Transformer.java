...
public interface Transformer<T> {
    ...
    /**
     * Returns an identity transformer returning the accepting parameter.
     *
     * @param <V> the target parameter type
     * @return the newly allocated identity transformer
     */
    static <V> Transformer<V> identity() {
        return x -> x;
    }
