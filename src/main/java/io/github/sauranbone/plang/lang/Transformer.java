...
/**
 * Functional interface that accepts a single parameter and returns any object.
 * <p>This interface is usually called by {@link Placeholder}, which transforms
 * receiving data into an output, that is then appended to the output within any
 * processor.
 * <p>This functional interface is relatively equal to {@link Function}, but
 * this interface requires other namings which is why the transformer does not
 * inherit {@link Function}.
 *
